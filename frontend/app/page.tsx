...
export default function LandingPage() {
  return (
    <div className="relative overflow-x-hidden">
      ...
      <section className="relative z-10 min-h-[100svh] px-4 sm:px-6 pt-20 sm:pt-24 pb-10 sm:pb-12 flex items-center">
        <div className="mx-auto w-full max-w-6xl grid lg:grid-cols-2 gap-7 sm:gap-10 items-center">
          <div className="space-y-6 animate-fade-up">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl text-gray-900">
            ...
            >
              <Link href="/markets" className="inline-flex items-center justify-center gap-2 w-full sm:w-auto">
                Try Now
          ...
          <div className="animate-fade-up mt-2 sm:-mt-10">
            <AletheiaStlViewer className="scale-100 sm:scale-[1.06]" />
